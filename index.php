...
<body>
	<!-- Header Section Starts -->
		...
		<!-- Starts -->
            ...
            include_once "views/mainHeader.php";
    ...
    include_once "views/components/slider.php";
				...
				<!-- Product #1 Starts -->
					<div class="col-md-3 col-sm-6">
						<div class="product-col">
							...
							<div class="caption">
								<h4><a href="product.htm">Simply Organic Seeds</a></h4>
				...
				<!-- Product #1 Starts -->
					<div class="col-md-3 col-sm-6">
						<div class="product-col">
							...
							<div class="caption">
								<h4>
									<a href="product-full.htm">Simply Organic Seeds</a>
								</h4>
								<div class="description">
									We are so lucky living in such a wonderful time. Our almost unlimited ...
								</div>
